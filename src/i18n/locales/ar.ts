...
export const arUiText: UiText = {
    eyebrow: "أسئلة تدريب منتقاة، بنك 1,000 سؤال قريبًا",
    appTitle: "اختبار المعرفة للمواطنة السويدية، تدريب منظّم",
    lead: "جميع الأسئلة مبنية على المادة الدراسية الرسمية من UHR",
    ...
    heroTrustBadge: "واجهة متعددة اللغات • تبقى الأسئلة باللغة السويدية؛ بدّل اللغة أثناء التدريب للمساعدة على الفهم ⭐ • لا حاجة لتنزيل تطبيق؛ تدرّب في أي وقت على الهاتف أو الكمبيوتر ⭐ • لوحة التقدم تعرض نقاط القوة والضعف في أي وقت",
...
استخدم Swedish Civics Test Preparation كدليل تدريب مستقل: اقرأ فصلاً من Sverige i fokus أولاً، ثم استخدم هذه الأسئلة السويدية لتراجع ما تتذكره. نحن لسنا الاختبار الرسمي ولا ننسخ أسئلة رسمية من الامتحان.`,
    ...
    topicFlavor: {
      ...
      "quick-start": "كل أسئلة التدريب السويدية المجانية الحالية.",
