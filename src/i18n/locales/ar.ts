...
export const arUiText: UiText = {
    ...
    heroTrustBadge: "أسئلة سويدية • شروحات متعددة اللغات • حوّل الشروحات في أي وقت • تدريب حسب فصول الدراسة الرسمية • حدّد نقاط ضعفك من نتائجك",
    ...
    proofStats: [
      { value: "48", label: "أسئلة تدريب منتقاة" },
