...
export const enUiText: UiText = {
    ...
    heroTrustBadge: "Multilingual interface • Questions stay in Swedish; switch language during practice to help understanding ⭐ • No app download needed; practice anytime on phone or computer ⭐ • Analyzes your results to find weak areas",
