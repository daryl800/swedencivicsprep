...
Use Swedish Civics Test Preparation as an independent practice guide: read a chapter in Sverige i fokus first, then use these Swedish questions to check what you remember. We are not the official test and we do not copy official exam questions.`,
    ...
    progressPromoTitle: "Progress dashboard",
    progressPromoBody: "See completed questions, weak chapters, and what to review next.",
    progressPromoCta: "View progress",
    ...
    accountIntro: "Sign in with your email to prepare for saved progress and paid access.",
    ...
    accountConfirmPasswordPlaceholder: "Repeat your password",
    accountSignInTab: "Sign in",
    accountSignUpTab: "Create account",
    accountSignInCta: "Sign in",
    accountSignUpCta: "Create account",
    accountGoogleCta: "Continue with Google",
    accountOauthDivider: "or use email",
    accountSignOutCta: "Sign out",
    accountSignedInTitle: "Signed in",
    accountSignedInBody: "Your account is ready. Progress sync and payment access will connect to this session next.",
    accountEmailSentTitle: "Check your email",
    accountEmailSentBody: "We sent a verification email. Open it to finish creating your account.",
    accountPasswordMismatch: "The passwords do not match.",
    accountMissingConfigTitle: "Account login is not connected yet",
    accountMissingConfigBody: "Add VITE_SUPABASE_URL and VITE_SUPABASE_PUBLISHABLE_KEY to enable Supabase login.",
    accountErrorTitle: "Sign-in failed",
    accountSyncNote: "For now, practice progress is still stored in this browser until cloud sync is added.",
    flipCard: "Flip card",
    nextCard: "Next card",
