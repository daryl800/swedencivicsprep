...
请把 Swedish Civics Test Preparation 当作独立练习指南：先阅读 Sverige i fokus 的一个章节，再用这些瑞典语问题检查自己记住了什么。我们不是官方测试，也不复制官方考试题。`,
    ...
    progressPromoTitle: "练习进度面板",
    progressPromoBody: "图形化查看已完成题目、薄弱章节和下一步复习方向。",
    progressPromoCta: "查看进度",
    ...
    accountTitle: "账号",
    accountIntro: "使用邮箱登录，为保存学习进度和付费权限做准备。",
    accountEmailLabel: "邮箱地址",
    accountEmailPlaceholder: "you@example.com",
    accountPasswordLabel: "密码",
    accountPasswordPlaceholder: "至少 6 个字符",
    accountConfirmPasswordLabel: "确认密码",
    accountConfirmPasswordPlaceholder: "再次输入密码",
    accountSignInTab: "登录",
    accountSignUpTab: "创建账号",
    accountSignInCta: "登录",
    accountSignUpCta: "创建账号",
    accountGoogleCta: "使用 Google 继续",
    accountOauthDivider: "或使用邮箱",
    accountSignOutCta: "退出登录",
    accountSignedInTitle: "已登录",
    accountSignedInBody: "账号已准备好。下一步可把进度同步和付费权限接到这个登录状态。",
    accountEmailSentTitle: "请查看邮箱",
    accountEmailSentBody: "我们已发送验证邮件。请打开邮件完成账号创建。",
    accountPasswordMismatch: "两次输入的密码不一致。",
    accountMissingConfigTitle: "账号登录尚未连接",
    accountMissingConfigBody: "添加 VITE_SUPABASE_URL 和 VITE_SUPABASE_PUBLISHABLE_KEY 后即可启用 Supabase 登录。",
    accountErrorTitle: "登录失败",
    accountSyncNote: "目前练习进度仍保存在当前浏览器中，之后再加入云端同步。",
    flipCard: "翻转卡片",
    nextCard: "下一张",
    backToHome: "返回首页",
