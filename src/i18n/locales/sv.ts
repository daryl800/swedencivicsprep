...
export const svUiText: UiText = {
    ...
    heroTrustBadge: "Svenska frågor • Träning efter officiella studiekapitel • Flerspråkiga förklaringar • Byt förklaringar när som helst • Identifiera svaga delar från dina resultat",
