...
export const svUiText: UiText = {
    ...
    heroTrustBadge: "Flerspråkigt gränssnitt • Frågorna är på svenska; byt språk under träningen för att underlätta förståelsen ⭐ • Ingen app behövs; träna när som helst på mobil eller dator ⭐ • Analyserar dina resultat för att hitta svaga delar",
