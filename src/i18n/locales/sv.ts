...
Använd Swedish Civics Test Preparation som en oberoende träningsguide: läs först ett kapitel i Sverige i fokus och använd sedan de svenska frågorna för att kontrollera vad du minns. Vi är inte det officiella provet och vi kopierar inte officiella provfrågor.`,
    ...
    progressPromoTitle: "Framstegspanel",
    progressPromoBody: "Se färdiga frågor, svaga kapitel och vad du bör repetera härnäst.",
    progressPromoCta: "Visa framsteg",
    ...
    accountTitle: "Konto",
    accountIntro: "Logga in med e-post för att förbereda sparade framsteg och betald åtkomst.",
    accountEmailLabel: "E-postadress",
    accountEmailPlaceholder: "du@example.com",
    accountPasswordLabel: "Lösenord",
    accountPasswordPlaceholder: "Minst 6 tecken",
    accountConfirmPasswordLabel: "Bekräfta lösenord",
    accountConfirmPasswordPlaceholder: "Skriv lösenordet igen",
    accountSignInTab: "Logga in",
    accountSignUpTab: "Skapa konto",
    accountSignInCta: "Logga in",
    accountSignUpCta: "Skapa konto",
    accountGoogleCta: "Fortsätt med Google",
    accountOauthDivider: "eller använd e-post",
    accountSignOutCta: "Logga ut",
    accountSignedInTitle: "Inloggad",
    accountSignedInBody: "Ditt konto är redo. Synk av framsteg och betalåtkomst kopplas till den här sessionen i nästa steg.",
    accountEmailSentTitle: "Kontrollera din e-post",
    accountEmailSentBody: "Vi har skickat ett verifieringsmeddelande. Öppna det för att slutföra kontot.",
    accountPasswordMismatch: "Lösenorden matchar inte.",
    accountMissingConfigTitle: "Kontoinloggning är inte kopplad ännu",
    accountMissingConfigBody: "Lägg till VITE_SUPABASE_URL och VITE_SUPABASE_PUBLISHABLE_KEY för att aktivera Supabase-inloggning.",
    accountErrorTitle: "Inloggningen misslyckades",
    accountSyncNote: "Just nu sparas träningsframsteg fortfarande i den här webbläsaren tills molnsynk läggs till.",
    flipCard: "Vänd kort",
    nextCard: "Nästa kort",
