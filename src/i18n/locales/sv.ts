...
export const svUiText: UiText = {
    ...
    heroTrustBadge: "Flerspråkigt gränssnitt • Frågorna är på svenska; byt språk under träningen för att underlätta förståelsen ⭐ • Ingen app behövs; träna när som helst på mobil eller dator ⭐ • Framstegspanel visar starka och svaga områden när som helst",
    ...
    proofStats: [
      { value: "1 000", label: "frågebank kommer snart" },
      { value: "13", label: "officiella kapitel" },
      { value: "48", label: "gratis träningsfrågor" }
    ],
