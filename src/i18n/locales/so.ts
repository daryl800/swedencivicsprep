...
export const soUiText = createLocalizedUiText(enUiText, {
    ...
    heroTrustBadge: "Interface luqado badan • Su'aaluhu waxay ku sii jiraan af Iswiidhish; beddel luqadda inta lagu jiro tababarka si aad u fahanto ⭐ • App lama soo dejinayo; mar kasta ku tababar telefoon ama kombiyuutar ⭐ • Wuxuu falanqeeyaa natiijooyinka tababarka si uu u helo meelaha daciifka ah",
    proofStats: [
