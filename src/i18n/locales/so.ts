...
export const soUiText = createLocalizedUiText(enUiText, {
    ...
    heroSubhead: "Mawduuc ahaan u tababar. Hel khaladaadka. Ogow waxa aad dib u eegayso",
    ...
    heroTrustBadge: "Interface luqado badan • Su'aaluhu waxay ku sii jiraan af Iswiidhish; beddel luqadda inta lagu jiro tababarka si aad u fahanto ⭐ • App lama soo dejinayo; mar kasta ku tababar telefoon ama kombiyuutar ⭐ • Guddi horumar ayaa mar kasta muujinaya meelaha xooggan iyo kuwa daciifka ah",
    proofStats: [
