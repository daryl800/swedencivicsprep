...
export const faUiText = createLocalizedUiText(enUiText, {
    ...
    heroTrustBadge: "رابط کاربری چندزبانه • پرسش‌ها به سوئدی می‌مانند؛ هنگام تمرین زبان را تغییر دهید تا بهتر بفهمید ⭐ • نیازی به دانلود اپ نیست؛ هر زمان با موبایل یا کامپیوتر تمرین کنید ⭐ • داشبورد پیشرفت هر زمان نقاط قوت و ضعف را نشان می‌دهد",
    proofStats: [
