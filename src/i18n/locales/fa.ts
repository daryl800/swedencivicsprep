...
export const faUiText = createLocalizedUiText(enUiText, {
    ...
    heroSubhead: "بر اساس موضوع تمرین کنید. اشتباه‌ها را پیدا کنید. بدانید چه چیزی را مرور کنید",
    ...
    navStartPractice: "شروع تمرین رایگان",
    heroPrimaryCta: "شروع تمرین رایگان",
    heroSecondaryCta: "انتخاب موضوع",
    heroTrustBadge: "رابط کاربری چندزبانه • پرسش‌ها به سوئدی می‌مانند؛ هنگام تمرین زبان را تغییر دهید تا بهتر بفهمید ⭐ • نیازی به دانلود اپ نیست؛ با موبایل یا کامپیوتر هر وقت بخواهید تمرین کنید ⭐ • نتیجه‌های تمرین را تحلیل می‌کند تا بخش‌های ضعیف را بیابد",
    proofStats: [
...
از Swedish Civics Test Preparation به عنوان یک راهنمای تمرین مستقل استفاده کنید: اول یک فصل از Sverige i fokus را بخوانید، بعد با این پرسش‌های سوئدی بررسی کنید چه چیزی را به یاد دارید. ما آزمون رسمی نیستیم و پرسش‌های رسمی امتحان را کپی نمی‌کنیم.`,
    ...
    topicFlavor: {
      ...
      "quick-start": "همه پرسش‌های تمرینی رایگان فعلی به سوئدی.",
