...
export const faUiText = createLocalizedUiText(enUiText, {
    ...
    lead: "همه پرسش‌ها بر پایه منبع رسمی مطالعه UHR هستند",
    ...
    heroTrustBadge: "رابط چندزبانه • پرسش‌ها به سوئدی می‌مانند؛ هنگام تمرین زبان را برای فهم بهتر عوض کنید ⭐ • نیازی به دانلود اپ نیست؛ هر زمان با موبایل یا کامپیوتر تمرین کنید ⭐ • داشبورد پیشرفت نقاط قوت و ضعف را نشان می‌دهد",
