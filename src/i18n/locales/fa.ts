...
export const faUiText = createLocalizedUiText(enUiText, {
    ...
    lead: "سوالات تمرینی به طور جامع موضوعات مواد آموزشی رسمی UHR را پوشش می‌دهند",
    heroSubhead: "بر اساس موضوع تمرین کنید. خطاها را پیدا کنید. بدانید چه چیزی را مرور کنید",
    languageNote: "پرسش‌ها به سوئدی می‌مانند. هنگام تمرین زبان را عوض کنید تا توضیح را آسان‌تر بفهمید و بهتر جذب کنید.",
    dailyPrompt: "تمرین رایگان را شروع کنید.",
    ...
    heroTrustBadge: "سوالات به طور پیش‌فرض به زبان سوئدی هستند؛ می‌توانید در هر زمان زبان را تغییر دهید تا بهتر درک کنید • پانل پیشرفت تمرین – نقاط قوت و ضعف خود را در هر زمان دنبال کنید • نیازی به دانلود برنامه نیست؛ در هر زمان با تلفن یا رایانه تمرین کنید ⭐",
...
از Swedish Civics Test Preparation به عنوان یک راهنمای تمرین مستقل استفاده کنید: اول یک فصل از Sverige i fokus را بخوانید، بعد با این پرسش‌های سوئدی بررسی کنید چه چیزی را به یاد دارید. ما آزمون رسمی نیستیم و پرسش‌های رسمی امتحان را کپی نمی‌کنیم.`,
    ...
    mockExamResume: "ادامه آزمون آزمایشی",
    mockExamPrevious: "قبلی",
    mockExamNext: "بعدی",
    mockExamSubmit: "ارسال آزمون",
    mockExamAnswered: (answered, total) => `${answered}/${total} پاسخ داده شده`,
    mockExamScore: (correct, total, percent) => `${correct}/${total} درست · ${percent}%`,
    mockExamResultTitle: "نتیجه آزمون آزمایشی",
    mockExamResultIntro: "این را فقط به عنوان نشانه تمرین استفاده کنید، نه پیش‌بینی رسمی. اول فصل‌های ضعیف را مرور کنید و بعد یک مجموعه ترکیبی دیگر انجام دهید.",
    mockExamWeakChapters: "فصل‌های ضعیف برای مرور",
    mockExamNoWeakChapters: "در این تلاش فصل ضعیف روشنی دیده نشد.",
    mockExamReviewAnswers: "مرور پاسخ‌ها",
    mockExamRestart: "شروع آزمون جدید",
    progressDashboardTitle: "داشبورد پیشرفت",
    progressAnsweredMetric: "پاسخ داده‌شده",
    progressAccessibleMetric: "بانک قابل دسترس",
    progressAccuracyMetric: "دقت",
    progressTodayMetric: "امروز",
    progressWeakChaptersTitle: "فصل‌های ضعیف",
    progressNoWeakChapters: "هنوز فصل ضعیف روشنی دیده نمی‌شود. برای سیگنال دقیق‌تر به پرسش‌های بیشتری پاسخ دهید.",
    progressRecentMistakesTitle: "اشتباه‌های اخیر",
    progressNoRecentMistakes: "هنوز اشتباهی ثبت نشده است.",
    progressReviewNow: "اکنون مرور کن",
    progressAttempts: (attempts) => `${attempts} تلاش`,
    progressWrongCount: (wrong) => `${wrong} اشتباه`,
    progressLocalOnlyNote: "تا زمانی که همگام‌سازی حساب اضافه شود، پیشرفت فقط در همین مرورگر ذخیره می‌شود.",
    flashcardsTitle: "فلش‌کارت‌ها",
    flashcardsPreview: "کارت‌های پرسش",
    flashcardsIntro: "پرسش‌های سوئدی را یکی‌یکی مرور کنید. وقتی آماده بودید پاسخ را نشان دهید و مشخص کنید آن را بلد هستید یا باید دوباره مرور شود.",
    flashcardsAllChapters: "همه فصل‌ها",
    flashcardsChapterFilter: "فصل",
    flashcardsShuffle: "درهم‌ریزی کارت‌ها",
    flashcardsQuestionSide: "پرسش",
    flashcardsAnswerSide: "پاسخ",
    flashcardsKnown: "بلد هستم",
    flashcardsReviewAgain: "دوباره مرور شود",
    flashcardsKnownCount: (count) => `${count} بلد هستم`,
    flashcardsReviewCount: (count) => `${count} برای مرور`,
    flashcardsCardProgress: (current, total) => `کارت ${current} از ${total}`,
    flashcardsDeckEmpty: "برای این انتخاب فلش‌کارتی موجود نیست.",
    ...
    appLanguageHint: "پرسش‌ها سوئدی می‌مانند. هنگام تمرین زبان را عوض کنید تا آسان‌تر بفهمید.",
    today: "امروز",
    total: "کل",
    ...
    topicFlavor: {
      ...
      "quick-start": "همه پرسش‌های رایگان سوئدی که اکنون باز هستند را تمرین کنید.",
