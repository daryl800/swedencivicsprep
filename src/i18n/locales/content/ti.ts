...
export const tiCitizenshipUpdate: CitizenshipUpdateText = {
...
export const tiFaqContent: FaqContent = {
    title: "ብዙሕ ዝሕተቱ ሕቶታት",
    ...
    items: [
      ...
      { question: "ነጻ ድዩ?", answer: "እወ። ናይ ነጻ ደረጃ ነጻ ኮይኑ ይቕጽል፣ ናይ ምርኢት ልምምድ ድማ ይህብ። ዝዓበየ ባንክ ሕቶታት፣ ፈተና ልምምድን ካልኦት ሙሉእ መእተዊ ባህርያትን ድሕሪ ሕጂ ክፍሊት ክደልዩ ይኽእሉ።" },
      { question: "ነፍሲ ወከፍ ፈተና ልምምድ ዝተፈላለዩ ሕቶታት ድዩ ዝጥቀም?", answer: "እወ። ነፍሲ ወከፍ ፈተና ልምምድ ካብ ዝርከብ ባንክ ሕቶታት ሓድሽ ዝተሓዋወሰ ስብስብ ይመርጽ፣ ሕቶታት ድማ ኣብ ወግዓዊ ምዕራፋት መጽናዕቲ ይዝርጋሕ። ስለዚ ብዙሕ ጊዜ ምፍታን ሰፊሕ ልምምድ ይህብ።" }
    ]
  };

export const tiLegalContent: LegalContent = {
