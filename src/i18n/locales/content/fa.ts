...
export const faCitizenshipUpdate: CitizenshipUpdateText = {
    title: "نکات مهم درباره آزمون شهروندی",
    source: "بر اساس اطلاعات UHR",
    summary: "اولین آزمون دانش جامعه در آگوست ۲۰۲۶ برگزار شد. UHR می‌گوید آزمون به زبان سوئدی، روی کاغذ و با پرسش‌های چندگزینه‌ای است. گزارش‌های عمومی اولین آزمون را حدود ۶۰ پرسش در ۹۰ دقیقه توصیف کردند.",
    intro: "مهم‌ترین نکات برای آمادگی ساده است:",
    bullets: [
      "آزمون جامعه‌شناسی به زبان سوئدی است",
      "پرسش‌ها چندگزینه‌ای هستند: چهار گزینه و یک پاسخ درست",
      "منبع مطالعه Sverige i fokus از UHR و Skolverket است",
      "تاریخ آزمون بعدی، تعداد پرسش‌ها و زمان آزمون را UHR اعلام می‌کند"
    ],
    note: "برای همین این سایت روی پرسش‌های تمرینی سوئدی، توضیح‌های روشن و اینکه بعداً چه چیزی را مرور کنید تمرکز دارد.",
...
export const faFaqContent: FaqContent = {
    ...
    items: [
      ...
      { question: "آیا رایگان است؟", answer: "بله. سطح رایگان رایگان می‌ماند و شامل تمرین نمونه است. بانک پرسش بزرگ‌تر، آزمون آزمایشی و قابلیت‌های دسترسی کامل ممکن است بعداً نیاز به پرداخت داشته باشند." },
      { question: "آیا هر آزمون آزمایشی پرسش‌های متفاوتی دارد؟", answer: "بله. هر آزمون آزمایشی یک مجموعه تازه و ترکیبی از بانک پرسش‌های در دسترس انتخاب می‌کند و پرسش‌ها را میان فصل‌های رسمی مطالعه پخش می‌کند، پس تلاش‌های تکراری تمرین گسترده‌تری می‌دهند." }
    ]
  };
